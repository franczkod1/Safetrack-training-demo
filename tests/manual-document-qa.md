...
- For Unterweisungen group confirmation, verify 14 participants stay on one physical A4 with the approximately 40 mm QR, all header metadata to its right, the larger writable signature-row height and unchanged supervisor/signature fields. For 100 participants verify 8 logical SafeTrack pages; if pagination occurs, every printed page must have its own QR/STPG and Seite x/y identity.
